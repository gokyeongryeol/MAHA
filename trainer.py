...
def train_model(args):
    ...
    #set model
    if 'NP' in args.model:
        model = NP(args.x_dim, args.hid_dim, args.r_dim, args.z_dim, args.y_dim,
                   args.lr, args.clipping, model=args.model)
    elif 'FELD' in args.model:
        model = FELD(args.x_dim, args.hid_dim, args.r_dim, args.z_dim, args.y_dim,
                     args.lr, args.clipping)
    elif 'MAHA' in args.model:
        model = MAHA(args.x_dim, args.hid_dim, args.r_dim, args.z_dim, args.y_dim,
                     args.lr, args.clipping, phase=args.phase)
